clc,clear all%Random Walk single agent
%%%%%%%%%%%%%%%%%%%%%%%
%     Parameters      %
%%%%%%%%%%%%%%%%%%%%%%%
numberOfAgents=1;
...
agentPosition=zeros(numberOfAgents,numberOfDimensions);
...
for t=1:100
  ...
  figure(1)
  clf
  scatter(agentPosition(1,1),agentPosition(1,2),100,'filled')
  axis([0 100 0 100])
  pause(0.0001)
end
%% Secound demonstration %Desease spreading for small number of agents
clc,clear all
%%%%%%%%%%%%%%%%%%%%%%%
%     Parameters      %
%%%%%%%%%%%%%%%%%%%%%%%
 ...
 hold on
  for i=1:numberOfAgents
    if storedAgentPosition(i,3,t)==1
      plot(storedAgentPosition(i,1,t),storedAgentPosition(i,2,t),'.b')
    elseif storedAgentPosition(i,3,t)==2
      plot(storedAgentPosition(i,1,t),storedAgentPosition(i,2,t),'.r')
    elseif storedAgentPosition(i,3,t)==3
      plot(storedAgentPosition(i,1,t),storedAgentPosition(i,2,t),'.g')
    else
      disp('ERROR!!!!')
    end
  end
